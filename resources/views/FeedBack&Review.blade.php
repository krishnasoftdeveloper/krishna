    ...
    <div class="container-fluid ">
      ...
      <div class="row">
          <div class="col-sm-12 col-md-12 my-3">
              ...
              <h4 class="d-inline"><i class="fa-sharp fa-solid fa-comment-pen icon"></i>
  ...
  <div class="container-fluid c1 py-3 my-2">
      ...
      <div class="row">
          ...
          <div class=" col-sm-4 col-md-4" style="line-height: 2rem;  ">
              <label class="" for="specificSizeSelect">Full Name:</label>
          ...
          <div class="  col-md-4 col-sm-4" style="line-height: 2rem;  ">
            <label class="" for="specificSizeSelect">Date of Booking:</label>
            <input type="date" class="form-control" id="inputPassword " placeholder="">
        </div>
         
        <div class="  col-md-4 col-sm-4" style="line-height: 2rem;  ">

            <label class="" for="specificSizeSelect">Overall Experience:</label>
            <select class="form-select" id="specificSizeSelect">

                <option value="1">Very Dissatisfied</option>
                <option value="2">Some What Dissatisfied</option>
                <option value="2">Neutral</option>
                <option value="2">Some What satisfied</option>
                <option value="2">Very Satisfied</option>
        ...
        <div class="  col-md-4 col-sm-4" style="line-height: 2rem;  ">
            ...
            <label class="" for="specificSizeSelect">Booking Process:</label>
            <select class="form-select" id="specificSizeSelect">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
          <button class="btn btn-primary me-md-2 Btn_Save w-25" type="button">Submit Feedback</button>
        ...
        <table class="table table-hover">
            <thead style="white-space: nowrap;">
              ...
              <th scope="col">Full Name:</th>
                ...
                <th scope="col">Booking Process:</th>
                <th scope="col" style="padding-left: 3.5rem;" >Action</th>
                </tr>
            ...
            <tbody style="white-space: nowrap;">
                <tr>
                    ...
                    <td><span class="text-center">abc</span></td>


                    <td><span class="text-center">abc@gmail.com
                        </span></td>
                   
                        <td>
                            <span class="text-center p-2">20/12/2023</span>
                        </td>
<td><span class="text-center">Online</span</td>
