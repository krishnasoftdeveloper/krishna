  ...
  <div class="container-fluid c1 py-3 my-2">
    ...
    Personal Information
      ...
      <div class="row mt-3">
          ...
          <div class="col-md-12 col-sm-12 d-flex"style="white-space: nowrap;">
              <label  for="specificSizeSelect">First Name:</label>
              <input type="text" class="form-control"  placeholder="Enter System Name" style="margin-left: 1.5rem;">
          </div>



          <div class="  col-md-12 col-sm-12 d-flex mt-2"style="white-space: nowrap;">

              <label class="" for="specificSizeSelect">Last Name:</label>
              <input type="text" class="form-control" placeholder="Enter Starting Year"style="margin-left: 1.5rem;">
          </div>

          <div class="  col-md-12 col-sm-12 d-flex mt-2"style="white-space: nowrap;">

            <label class="" for="specificSizeSelect">Email:</label>
            <input type="text" class="form-control" placeholder="Enter Address" style="margin-left: 3.8rem;">
        </div>

        
        <button class="btn  mb-5 mt-3  Btn_Save"
        type="button" style="margin-left: 5rem;">Update</button>
  </main>
