    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6 col-md-6 my-3">
                <h4 class="d-inline"><i class="fa-solid fa-eye icon"></i>
                   View Booking History </h4>
            </div>
        </div>
    </div>
<!-- edituser -->
            ...
            <table class="table table-hover  ">
                <thead style="white-space: nowrap;">     
                  <th> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></th>
                    ...
                    <th scope="col"style="padding-left: 1rem;">USER</th>
                    <th scope="col" style="padding-left: 2rem;">ROUTE</th>

                    <th scope="col" style="padding-left: 2rem;">DATE</th>
                    <th scope="col" >AMOUNT</th>
                    <th scope="col" style="padding-left: 2rem;">ACTION</th>
                    </tr>
                </thead>
