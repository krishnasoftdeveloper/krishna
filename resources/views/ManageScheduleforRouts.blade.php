...
<!-- End Sidebar-->
    ...
    <div class="container-fluid ">
      ...
      <div class="row">
          <div class="col-sm-4 col-md-4 my-3">
              ...
              <h4 class="d-inline" style="font-size: 1.3rem;"><i class="fa-solid fa-book-section icon"></i>
                 Manage Schedules for Routes
              </h4>
          </div>
  ...
  <div class="container-fluid c1 py-3 my-2">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
          <button class="btn btn-primary me-md-2 Btn_Save w-25" type="button">ADD SCHEDULE</button>
          ...
          <table class="table table-hover">
              <thead style="white-space: nowrap;">
                ...
                <th> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></th>
                  ...
                  <th scope="col" style="text-align: center; padding-right: 6rem;">Action</th>
                  </tr>
