...
<!-- End Sidebar-->
    ...
    <div class="container-fluid ">
      ...
      <div class="row">
          <div class="col-sm-4 col-md-4 my-3">
              ...
              <h4 class="d-inline"><i class="fa-duotone fa-bus-simple icon"></i>
                 Manage Bus/Train 
              </h4>
          </div>
  ...
  <div class="container-fluid c1 py-3 my-2">
      ...
      <div class="row">
        <div class=" col-sm-3 col-md-3" style="line-height: 2rem;  ">
          ...
          <div class="  col-md-3 col-sm-3" style="line-height: 2rem;  ">

              <label class="" for="specificSizeSelect">Departure Stop:</label>
              <input type="text" class="form-control" placeholder="Departure Stops">
          </div>
          

          <div class="col-sm-3 col-md-3" style="line-height: 2rem;  ">

              <label class="" for="autoSizingInputGroup">Arrival Stop:</label>
              <input type="text" class="form-control" id="inputPassword " placeholder="Arrival Stop">
        ...
        <div class="col-sm-3 col-md-3" style="line-height: 2rem;  ">
            ...
            <label class="" for="autoSizingInputGroup">Arrival Time:</label>
            <input type="time" class="form-control" id="inputPassword " placeholder="time">
        ...
        <div class="col-sm-3 col-md-3" style="line-height: 2rem;  ">
            ...
            <input type="number" class="form-control" id="inputPassword " placeholder="seats">

        </div>
      </div>

      <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
          <button class="btn btn-primary me-md-2 Btn_Save w-25" type="button">Manage Transport</button>
  ...
  <div class="container-fluid c1  my-4 py-2">
        ...
        <div class="table-responsive ">
          <table class="table table-hover">
              <thead style="white-space: nowrap;">
                ...
                <th scope="col">Select Transport Type:</th>
                  <th scope="col">Route Name:</th>
                  <th scope="col">Departure Stop:</th>
                  <th scope="col">Arrival Stop:</th>
    
                  <th scope="col ">Departure Time:</th>
                  <th scope="col ">Arrival Time:</th>
                  <th scope="col ">Available Seats:</th>
                  
                  <th scope="col" style="text-align: center; padding-left: 1rem;">Action</th>
                  </tr>
              ...
              <tbody style="white-space: nowrap;">
                  <tr>
                    ...
                    <th> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></th>
                      ...
                      <td><span class="text-center">rajwada
                          </span></td>
                     
                          <td>
                              <span class="text-center p-2">TI</span>
                          </td>

                          <td>
                            <span class="text-center p-2">rau</span>
                        </td>
                          <td>
                              <span class="text-center p-2">2:00pm</span>
                          </td>
                          <td>
                            <span class="text-center p-2">3:00pm</span>
                        </td>
      ...
      <div class="d-grid gap-2 d-flex justify-content-md-end mt-3 ">
