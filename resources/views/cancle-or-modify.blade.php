...
<!-- End Sidebar-->
  ...
  <div class="container-fluid c1 py-3 my-2">
      ...
      <div class="row">
          ...
          <div class="col-sm-12 col-md-12 mt-3 " style="line-height: 2rem;  ">

            <label class="" for="autoSizingInputGroup">Reason for Cancellation/Modification:</label>
            <input type="text" class="form-control" id="inputPassword " placeholder="Enter Your Reason">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
          <button class="btn btn-primary me-md-2 Btn_Save" type="button">Activate</button>
          <button class="btn btn-primary Btn_Close" type="button">Deactivate</button>
          ...
          <table class="table table-hover" >
              <thead style="white-space: nowrap;">
                <th> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></th>
                  ...
                  <th scope="col" style="text-align: center; padding-right: 9rem;">Action</th>
                  </tr>
              ...
              <tbody style="white-space: nowrap;">
                  <tr>
                    ...
                    <th> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></th>
                      ...
                      <td><span class="text-center">AppleAppleAppleApple
                          </span></td>
                          ...
                          <td>
                              <span class="text-center p-2">Pending</span>
                          </td>
