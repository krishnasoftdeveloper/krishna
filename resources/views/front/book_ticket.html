...
<body>
    ...
    <main>
        <div class="container mb-2 border-bottom">
            <div class="row row-cols-md-1 px-0">
                <div class="col-md-6 p-0">
                    <ul class="nav">
                        <li class="nav-item">
                            <a href="#" class="nav-link link-body-emphasis px-2 active align-items-center d-flex gap-2"
                                aria-current="page">
                                <p class="mb-0 text-start">Departure</p>
                                <img src="./images/Icon awesome-check.svg" width="12" height="12">
                            </a>
                        </li>
                ...
                <div class="col-md-12">
                    <ul class="nav">
                        <li class="list-group-item">
                            <p class="mb-0 fw-bold">Departure</p>
                            <small>BOSTON › NEW YORK • MON, DEC 11</small>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container px-0">
            <div class="row">
                <div class="col-md-8">
                    <div class="container mb-2 px-0">
                        <div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#"
                                                ...
                                                <img src="./images/Icon material-star-1.svg" alt="twbs" width="16"
                                    ...
                                    <div class="d-flex justify-content-between ps-0 align-items-center flex-wrap">
                                        <div class="d-flex align-items-center mb-2">
                                            <img src="./images/Icon awesome-bus-alt-1 circle.svg" alt="bestbuses"
                                    ...
                                    <ul class="list-group">
                                            ...
                                            <ul>
                                                ...
                                                <li class="mb-0 text-start text-black" style="list-style-type: none;">
                                                    <p class="mb-0">South Station <span style="color: #ff7f00;">map <img
                                                                src="./images/Icon awesome-map.svg" width="16px"
                                                                height="16px" alt=""></span></p>
                                        ...
                                        <li class="list-group-item border-0 bg-transparent d-flex">
                                            ...
                                            <a href="#" class="btn fw-medium border rounded-5 ms-2" role="button"
                                                aria-current="true">
                                                <img src="./images/Icon awesome-restroom.svg" width="16" height="16"
                                                    alt="">
                            ...
                            <a class="btn" href="#" role="button" style="background-color: #ff7f00;">
                                <span class="text-white">Book</span>
                                <span class="fw-bold mb-0 ms-1" style="color: #011950;">$30.00</span>
                ...
                <div class="col-md-4 p-2">
                    <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light border-bottom border-top border-bottom-lg-0 border-end-lg"
                        id="sidebar">
                        <div class="container-fluid d-block px-0" style="min-height: 0;">
                                        ...
                                        <div class="accordion-body py-0">
                                            <ul class="list-group">
                                                <li class="list-group-item p-1 border-0">
                                                    <ul
                                                        class="nav dropdown-item p-0 align-items-center d-flex justify-content-between">
                                                        <li class="nav-item">
                                                            <p class="mb-0 text-start">Passenger</p>
                                                        </li>
                                                        <li class="nav-item d-flex align-items-center">
                                                            <a href="#"
                                                                class="nav-link link-body-emphasis px-2 active align-items-center d-flex gap-2"
                                                                aria-current="page">
                                                                <img src="./images/Icon feather-plus-circle.svg"
                                                            ...
                                                            <a href="#"
                                                                class="nav-link link-body-emphasis px-2 active align-items-center d-flex gap-2"
                                                                aria-current="page">
                                                                <img src="./images/Icon feather-minus-circle.svg"
                                                                    width="16" height="16" alt="">
                                                            </a>
                                                        </li>
                                                    </ul>
                    ...
                    <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light border-bottom-lg-0 border-end-lg"
                        id="sidebar">
                        <div class="container-fluid d-block px-0" style="min-height: 0;">
                            <div class="accordion p-0" id="accordionExample">
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            style="padding: 16px 24px;">
                                            <img src="./images/Icon awesome-plus-circle.svg" width="24" height="24" alt="">
                                            <span class="ms-2">Add Return Trip</span>
                                        </button>
                                    </h2>
