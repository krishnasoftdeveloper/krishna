    ...
    <div class="container-fluid ">
      ...
      <div class="row">
          <div class="col-sm-4 col-md-4 my-3">
              ...
              <h4 class="d-inline"><i class="fa-sharp fa-solid fa-location-crosshairs icon"></i>
                 Track Bus/Train Status
              </h4>
          </div>
  ...
  <div class="container-fluid c1 py-3 my-2">
      ...
      <div class="row">
        <div class=" col-sm-6 col-md-6" style="line-height: 2rem;  ">
          ...
          <div class="  col-md-12 col-sm-12" style="line-height: 2rem;  ">

              <label class="" for="specificSizeSelect">Current Status:</label>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
          <button class="btn btn-primary me-md-2 Btn_Save w-25" type="button">Track Status</button>
              ...
              <tbody style="white-space: nowrap;">
                  <tr>
                    ...
                    <th> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></th>
                      ...
                      <td><span class="text-center">jawahar marg
                          </span></td>
