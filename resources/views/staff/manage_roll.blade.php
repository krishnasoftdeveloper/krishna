    ...
    <div class="container-fluid ">
      ...
      <div class="row">
          <div class="col-sm-4 col-md-4 my-3">
              ...
              <h4 class="d-inline"><i class="fa-regular fa-cart-shopping icon"></i>
               Manage Rolls
              </h4>
          </div>
  ...
  <div class="container-fluid c1 py-3 my-2">
      ...
      <div class="row">
          ...
          <div class="col-sm-12 col-md-4" style="line-height: 2rem;  ">
              <label class="" for="specificSizeSelect">Passenger Name:</label>
          ...
          <div class="col-sm-12 col-md-4" style="line-height: 2rem;  ">
              ...
              <label class="" for="specificSizeSelect">Card Number:</label>
          ...
          <div class="col-sm-12 col-md-4 mt-3" style="line-height: 2rem;  ">

              <label class="" for="autoSizingInputGroup">Expiry Date</label>
          ...
          <div class="col-sm-12 col-md-4 mt-3" style="line-height: 2rem;  ">
            ...
            <label class="" for="autoSizingInputGroup">CVV</label>
            <input type="text" class="form-control" id="inputPassword " placeholder="Enter CVV">
          ...
          <div class="col-sm-12 col-md-4 mt-3" style="line-height: 2rem;  ">
            ...
            <input type="text" class="form-control" id="inputPassword " placeholder="Enter Payment Amount">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
          <button class="btn btn-primary me-md-2 Btn_Save " type="button" style="font-size: 1rem;" data-bs-toggle="modal" data-bs-target="#exampleModal">Submit Payment</button>

          <button class="btn btn-primary Btn_Close" type="button">Cancle</button>
      </div>
  </div>

  <!-- payment start -->
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="background-color: aliceblue !important; border-radius: 7%;">
      <div class="modal-content">
        <div class="modal-header">
          <div class="col-sm-6 col-md-12 my-3" style="margin-top: 5rem; text-align: center;">
            
            <h4 class="d-inline" >
              <!-- <i class="fa-solid fa-user-plus icon"></i> -->
              <b>Your Payment is Successfully Done</b>
            </h4>

            <br>
            <i class="fa-solid fa-badge-check mt-4 icon" style="font-size: 3rem;"></i>
          </div>
