  ...
  <main id="main" class="main">
    ...
    <div class="container-fluid ">
        ...
        <div class="row">
            <div class="col-sm-4 col-md-4 my-3">
                ...
                <h4 class="d-inline"><i class="fa-solid fa-badge-percent icon"></i>
                    Apply Discount or Offers
                </h4>
            </div>
    ...
    <div class="container-fluid c1 py-3 my-2">
        ...
        <div class="row">
          ...
          <div class=" col-sm-12 col-md-3" style="line-height: 2rem;  ">
            ...
            <div class=" col-sm-4 col-md-3" style="line-height: 2rem;  ">
                <label class="" for="specificSizeSelect">Discount Type:</label>
            ...
            <div class="  col-md-3 col-sm-12" style="line-height: 2rem;  ">
                ...
                <label class="" for="specificSizeSelect">Discount Value:</label>
                <input type="text" class="form-control" placeholder="Enter Discount Value">
            </div>

            <div class="  col-md-3 col-sm-12" style="line-height: 2rem;  ">
    
                <label class="" for="specificSizeSelect">Validity (days):</label>
                <input type="text" class="form-control" placeholder="Enter Validity in Days">
            </div>
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
            <button class="btn btn-primary me-md-2 Btn_Save" type="button">Apply</button>
                    ...
                    <tr>
                      ...
                      <th> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></th>
                        ...
                        <td><span class="text-center">Indore
                            ...
                            <td>
                                <span class="text-center p-2">15</span>
                            </td>
