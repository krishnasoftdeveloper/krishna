...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav1" data-bs-toggle="collapse" href="#">
          <i class="fa-solid fa-folder-user"></i><span>Staff Management</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="manage-current-booking.html">
              <i class="bi bi-circle"></i><span>Manage current bookings
              </span>
            </a>
          </li>
          <li>
      ...
      <li class="nav-item">
        ...
        <ul id="icons-nav2" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="icons-boxicons.html">
              <i class="bi bi-circle"></i><span>Maintenance and updates</span>
            </a>
          </li>
        </ul>
      </li>
  ...
  <main id="main" class="main">
    ...
    <div class="container-fluid ">
      ...
      <div class="row">
        <div class="col-sm-4 col-md-6 my-3">

          <h4 class="d-inline"><i class="fa-duotone fa-seat-airline icon"></i>
            Seat Availability on specific routes
          </h4>
        </div>
    ...
    <div class="container-fluid c1 py-3 my-2">
      ...
      <div class="row">
        ...
        <div class="  col-md-4 col-sm-12" style="line-height: 2rem;  ">
          ...
          <label class="" for="specificSizeSelect">Date:</label>
          <input type="date" class="form-control" placeholder="20-12-2023">
        </div>


        <div class="col-sm-4 col-md-4" style="line-height: 2rem;  ">

          <label class="" for="autoSizingInputGroup">Available Seats:</label>
          <input type="number" class="form-control" id="inputPassword " placeholder="Available Seats">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
        <button class="btn btn-primary me-md-2 Btn_Save w-25" type="button">UPDATE AVAILABILITY</button>
    ...
    <div style="overflow: auto;">
      <div class="container-fluid ">
        <div class="filter py-2 row c1  ">
          <div class="col-md-8 col-sm-8  d-flex">
            ...
            <button class="btn btn-primary  Btn_Save mx-1 " type="button">Excel</button>
            <button class="btn btn-primary  Btn_Save mx-1" type="button">Save</button>
          </div>



          <div class="col-md-3 col-sm-3  ">
            <label for="" class="py-2">Search</label><input type="search" class="p-2 rounded ">
          </div>
      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr>
            ...
            <td><span class="text-center">MG ROAD</span></td>


            <td><span class="text-center">20/12/2023
              </span></td>

            <td>
              <span class="text-center p-2">6</span>
            </td>
      ...
      <div class="row">
        <div class="col-md-10 col-sm-10">Showing 1st to 10 of All entries</div>

        <div class="col-md-11 col-sm-11 px-1">
