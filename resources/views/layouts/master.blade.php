    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="manage_user_account">
              <i class="bi bi-circle"></i><span>Manage user accounts</span>
            </a>
          </li>
          <li>
            <a href="view-booking-history">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav1" data-bs-toggle="collapse" href="manage_staff">
