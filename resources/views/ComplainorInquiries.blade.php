        ...
        <div class="container-fluid ">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 my-3">
                    ...
                    <h4 class="d-inline"><i class="fa-brands fa-searchengin icon"></i>
                        Responding to User Complaints or Inquiries
                    </h4>
                </div>
        ...
        <div class="container-fluid c1 py-3 my-2">
            ...
            <div class="row">
                ...
                <div class=" col-sm-6 col-md-6" style="line-height: 2rem;  ">
                    <label class="" for="specificSizeSelect">User's Email Addres:</label>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
                <button class="btn btn-primary me-md-2 Btn_Save w-25" type="button">Send Response</button>
