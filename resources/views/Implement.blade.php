    ...
    <main id="main" class="main">
        ...
        <div class="container-fluid ">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 my-3">
                    ...
                    <h4 class="d-inline"><i class="fa-solid fa-gauge-circle-plus icon"></i>
        ...
        <div class="container-fluid c1 py-3 my-2">
            ...
            <div class="row">
                ...
                <div class=" col-sm-6 col-md-6" style="line-height: 2rem;  ">
                    <label class="" for="specificSizeSelect">Improvement Summary:</label><br>
                ...
                <div class=" col-sm-6 col-md-6" style="line-height: 2rem;  ">
                    <label class="" for="specificSizeSelect">Implementation Details:</label><br>
                    <div class="form-floating">
                        <textarea class="form-control " placeholder="Leave a comment here"
                            id="floatingTextarea"></textarea>
                ...
                <div class=" col-sm-6 col-md-6" style="line-height: 2rem;  ">
                    <label class="" for="specificSizeSelect">Expected Timeline:</label>
                    <input type="text" class="form-control" placeholder="">
                </div>



                <div class="  col-md-6 col-sm-6" style="line-height: 2rem;  ">

                    <label class="" for="specificSizeSelect">Feedback Reference (if applicable):</label>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
                <button class="btn btn-primary me-md-2 Btn_Save w-25" type="button">Implementation Improvement</button>
