    ...
    <div class="container-fluid ">
      ...
      <div class="row">
          <div class="col-sm-4 col-md-4 my-3">
              ...
              <h4 class="d-inline"><i class="fa-sharp fa-solid fa-bell icon"></i>
  ...
  <div class="container-fluid c1 py-3 my-2">
      ...
      <div class="row">
          ...
          <div class=" col-sm-4 col-md-4" style="line-height: 2rem;  ">
              <label class="" for="specificSizeSelect">Email Notifications:</label>
          ...
          <div class="  col-md-4 col-sm-4" style="line-height: 2rem;  ">
              ...
              <label class="" for="specificSizeSelect"> SMS Notifications:</label>
              <select class="form-select" id="specificSizeSelect">
          ...
          <div class="  col-md-4 col-sm-4" style="line-height: 2rem;  ">
            ...
            <label class="" for="specificSizeSelect">Push Notifications:</label>
            <select class="form-select" id="specificSizeSelect">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end me-4 mt-3">
          <button class="btn btn-primary me-md-2 Btn_Save w-25" type="button">Save Preferences</button>
