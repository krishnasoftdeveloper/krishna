  ...
  <main id="main" class="main">
    ...
    <div class="container-fluid ">
      ...
      <div class="row">
        <div class="col-sm-4 col-md-4 my-3">
          ...
          <h4 class="d-inline" style="font-size: 1.2rem;"><i class="fa-solid fa-book-section icon"></i>
    ...
    <div class="container-fluid c1 py-3 my-2">
      ...
      <div class="row">
        ...
        <div class=" col-sm-4 col-md-6 mt-2" style="line-height: 2rem;  ">
          <label class="" for="specificSizeSelect">CVV:</label>
          <input type="text" class="form-control" placeholder="Enter CVV">
        </div>

        <div class=" col-sm-4 col-md-6 mt-2" style="line-height: 2rem;  ">
          <label class="" for="specificSizeSelect">Cardholder Name:</label>
        ...
        <table class="table table-hover">
          ...
          <tbody style="white-space: nowrap;">
            <tr>
              ...
              <th> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></th>
              <td><span class="text-center">#123456789</span></td>




              <td>
                <span class="text-center p-2">04-01-2024</span>
              </td>
              <td>
                <span class="text-center p-2">#123456</span>
              </td>
              <td>
                <span class="text-center p-2">asdfghikp</span>
              </td>
